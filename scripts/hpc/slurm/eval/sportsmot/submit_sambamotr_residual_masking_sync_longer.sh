...
CONFIG=./configs/sambamotr/sportsmot/def_detr/train_residual_masking_sync_longer.yaml
OUT_DIR=./pretrained/sambamotr/sportsmot/sambamotr_residual_masking_sync_longer_sched2_lr_0.0002
MODEL_NAME=checkpoint_17.pth
BS=1 
...
# for DET_SCORE_THRESH in 0.5; do
# for TRACK_SCORE_THRESH in 0.5; do
# for MISS_TOLERANCE in 30 40; do
#      EXP_NAME=det_${DET_SCORE_THRESH}_track_${TRACK_SCORE_THRESH}_miss_${MISS_TOLERANCE}_interval_${EVAL_INTERVAL}
#      ID=$(sbatch \
#           --parsable \
#           -t ${TIME} \
...
# TODO: try 05 04 35 (running)
# TODO: fix the miss tolerance (30 35 40?)
# TODO: then ablate on det score thr
# TODO: try to lower track thr
PARTITION=gpu20  # PARTITION=(gpu16 | gpu20 | gpu22) 
for DET_SCORE_THRESH in 0.5; do
for TRACK_SCORE_THRESH in 0.5; do
