...
CONFIG=./configs/sambamotr/dancetrack/def_detr/train_residual_masking.yaml
OUT_DIR=./pretrained/sambamotr/dancetrack/sambamotr_residual_masking_lr_0.0002
MODEL_NAME=checkpoint_13.pth
BS=1 
