#!/bin/bash
DATASET=dancetrack
JOB_NAME=sambamotr_residual_masking_dropout_sync_longer_pretrained
CONFIG=./configs/sambamotr/${DATASET}/def_detr/train_residual_masking_dropout_sync_longer_pretrained.yaml
