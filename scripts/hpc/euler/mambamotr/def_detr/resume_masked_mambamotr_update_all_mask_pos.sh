#!/bin/bash
JOB_NAME=mambamotr_dancetrack_update_all_mask_pos
# JOB_NAME=masked_mambamotr_dancetrack_update_all_mask_pos
CONFIG=./configs/masked_mambamotr/def_detr/train_dancetrack_update_all_mask_pos.yaml
