#!/bin/bash
JOB_NAME=debug_resume_sambamotr_curriculum_dancetrack
...
CHECKPOINT=/cluster/work/cvl/segum/workspaces/sambamotr/outputs/sambamotr_curriculum_dancetrack_lr_0.0002/checkpoint_14.pth
BS=1 
