#!/bin/bash
JOB_NAME=new_mambamotr_dancetrack_residual_masking_sync_prior
CONFIG=./configs/masked_mambamotr/def_detr/train_dancetrack_residual_masking_sync_prior.yaml
