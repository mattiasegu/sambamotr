#!/bin/bash
JOB_NAME=24_longer_mambamotr_dancetrack_residual_masking_sync
...
CHECKPOINT=/cluster/work/cvl/segum/workspaces/sambamotr/outputs/new_mambamotr_dancetrack_residual_masking_sync_lr_0.0002/checkpoint_13.pth
