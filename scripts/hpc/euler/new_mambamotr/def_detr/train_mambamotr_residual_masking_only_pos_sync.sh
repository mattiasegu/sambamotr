#!/bin/bash
JOB_NAME=new_mambamotr_dancetrack_residual_masking_only_pos_sync
CONFIG=./configs/masked_mambamotr/def_detr/train_dancetrack_residual_masking_only_pos_sync.yaml
