...
DATASET=dancetrack
JOB_NAME=${DATASET}/sambamotr_residual_masking_sync_dropout_longer_int_5
CONFIG=configs/sambamotr/${DATASET}/def_detr/train_residual_masking_sync_dropout_longer_int_5.yaml
