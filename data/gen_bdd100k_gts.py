...
# '''for filter'''
img_dir = './DatasetsForSambaMOTR/BDD100K/images/track/'
label_dir = './DatasetsForSambaMOTR/BDD100K/labels/box_track_20/'
save_label_dir = './DatasetsForSambaMOTR/BDD100K/filter_labels/track'
split = 'train'
